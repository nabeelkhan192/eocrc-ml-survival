...
were independently verified on Aug 12, 2026; further entries were verified
in the v3.0 audit (Aug 2026) and in the Aug 27, 2026 reference-verification
pass (Zhao journal version; Korean XAI PMID). Verification therefore
occurred on several dates, and each entry below carries its own explicit
current status — VERIFIED entries have been opened at source; entries still
marked U remain unverified and are not relied upon for the novelty claim.
...
| A2 | **VERIFIED (journal version, Aug 27 2026)** — Zhao Y, Li C, Shu C, Wu Q, Li H, Xu C, Li T, Wang Z, Luo Z, He Y. Tackling small sample survival analysis via transfer learning: a study of colorectal cancer prognosis. Artif Intell Med. 2026;178:103426. doi:10.1016/j.artmed.2026.103426. PMID 42019107. (Earlier preprint: arXiv:2501.12421, 2025.) | SEER stage I CRC (n=27,379) as **source**, fine-tuned to 728 West China Hospital patients; DeepSurv/DeepHit/Cox-CC/RSF + new transfer survival forest | Institution/country transfer with **fine-tuning**; not age-group transportability of frozen models, no EO focus, no calibration-repair framing. Distinguish in Discussion. |
...
| A4 | **VERIFIED — PMID 41066920** — Explainable AI for colorectal cancer mortality and risk factor prediction in Korea: a nationwide cancer cohort study. Int J Med Inform. 2025 (Korean NHIS-derived cancer cohort; LightGBM; SHAP; subgroup analysis by age at diagnosis). This is the same paper formerly listed as U4; the duplicate unverified entry has been retired. | XAI mortality prediction with SHAP across age-at-diagnosis subgroups (non-SEER, Korea) | Age-related SHAP differences are examined, so our H4 contrast is framed as descriptive/confirmatory, not novel; no frozen cross-age transport or recalibration analysis. |
...
| ~~U4~~ | **RETIRED — duplicate of A4** (PMID 41066920, verified). See the verified-anchors table above. | — | resolved |
...
2. Never claim EO-vs-older comparison is new (A1) or that SHAP age
   contrasts are new (A4, verified — PMID 41066920).
...
Result: the Zhao et al. transfer-learning work was subsequently confirmed
in its peer-reviewed journal version (Artif Intell Med. 2026;178:103426;
PMID 42019107; verified Aug 27, 2026; earlier preprint arXiv:2501.12421 —
